...
export default function ContactPage() {
  return (
    <main style={{ backgroundColor: "var(--stone)", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      <Navbar />
      <section style={{ flex: 1, paddingTop: "140px", paddingBottom: "80px", paddingLeft: "2.5rem", paddingRight: "2.5rem", display: "flex", alignItems: "center", gap: "4rem" }}>
        ...
        <div style={{ flex: 1 }}>
          <p style={{ fontFamily: K, fontWeight: 400, fontSize: "32px", lineHeight: 1.6, color: "var(--ink)", marginBottom: "3rem" }}>
          ...
          <p style={{ fontFamily: K, fontWeight: 400, fontSize: "32px", lineHeight: 1.8, color: "var(--ink)", marginBottom: "1.5rem" }}>
            11, 13th Cross 5th main Srinidhi layout,<br />
            Konanakunte, Bangalore — 560062
          </p>
          <p style={{ fontFamily: K, fontWeight: 400, fontSize: "32px", color: "var(--ink)", marginBottom: "1rem" }}>
            +91-98842182133
          </p>
          <p style={{ fontFamily: K, fontWeight: 400, fontSize: "32px", color: "var(--ink)" }}>
